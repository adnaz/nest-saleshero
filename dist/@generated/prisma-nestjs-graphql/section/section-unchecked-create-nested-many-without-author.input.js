...
exports.SectionUncheckedCreateNestedManyWithoutAuthorInput = void 0;
...
let SectionUncheckedCreateNestedManyWithoutAuthorInput = class SectionUncheckedCreateNestedManyWithoutAuthorInput {
};
__decorate([
    (0, graphql_1.Field)(() => [section_create_without_author_input_1.SectionCreateWithoutAuthorInput], { nullable: true }),
    __metadata("design:type", Array)
], SectionUncheckedCreateNestedManyWithoutAuthorInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], SectionUncheckedCreateNestedManyWithoutAuthorInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], SectionUncheckedCreateNestedManyWithoutAuthorInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [section_where_unique_input_1.SectionWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], SectionUncheckedCreateNestedManyWithoutAuthorInput.prototype, "connect", void 0);
SectionUncheckedCreateNestedManyWithoutAuthorInput = __decorate([
    (0, graphql_2.InputType)()
], SectionUncheckedCreateNestedManyWithoutAuthorInput);
exports.SectionUncheckedCreateNestedManyWithoutAuthorInput = SectionUncheckedCreateNestedManyWithoutAuthorInput;
//# sourceMappingURL=section-unchecked-create-nested-many-without-author.input.js.map