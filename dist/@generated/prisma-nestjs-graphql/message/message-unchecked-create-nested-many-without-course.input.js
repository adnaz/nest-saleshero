...
exports.MessageUncheckedCreateNestedManyWithoutCourseInput = void 0;
...
let MessageUncheckedCreateNestedManyWithoutCourseInput = class MessageUncheckedCreateNestedManyWithoutCourseInput {
};
__decorate([
    (0, graphql_1.Field)(() => [message_create_without_course_input_1.MessageCreateWithoutCourseInput], { nullable: true }),
    __metadata("design:type", Array)
], MessageUncheckedCreateNestedManyWithoutCourseInput.prototype, "create", void 0);
__decorate([
    ...
    __metadata("design:type", Array)
], MessageUncheckedCreateNestedManyWithoutCourseInput.prototype, "connectOrCreate", void 0);
__decorate([
...
], MessageUncheckedCreateNestedManyWithoutCourseInput.prototype, "createMany", void 0);
__decorate([
    (0, graphql_1.Field)(() => [message_where_unique_input_1.MessageWhereUniqueInput], { nullable: true }),
    __metadata("design:type", Array)
], MessageUncheckedCreateNestedManyWithoutCourseInput.prototype, "connect", void 0);
MessageUncheckedCreateNestedManyWithoutCourseInput = __decorate([
    (0, graphql_2.InputType)()
], MessageUncheckedCreateNestedManyWithoutCourseInput);
exports.MessageUncheckedCreateNestedManyWithoutCourseInput = MessageUncheckedCreateNestedManyWithoutCourseInput;
//# sourceMappingURL=message-unchecked-create-nested-many-without-course.input.js.map